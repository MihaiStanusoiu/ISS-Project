...
public class UserTest {
    ...
    public void getAllNotifications() throws Exception {
        ...
        try{
            ...
            for(Integer index = 0; index < notifications.size(); index++) {
                if (notifications.get(index).getText().equals("payment"))
                    isNote = true;
                if (notifications.get(index).getText().equals("subscription"))
                    isNote2 = true;
                if (notifications.get(index).getText().equals("late"))
                    isNote3 = true;
            }
